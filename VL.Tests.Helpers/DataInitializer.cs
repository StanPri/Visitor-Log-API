...
namespace VL.Tests.Helpers
{
    ...
    public class DataInitializer
    {
        ...
        public static List<AssetType> GetAllAssetTypes()
        {
            ...
            {
                new AssetType() { ID = 1, CreatedByUserID = "_admin", CreatedDate = new DateTime(2016, 1, 1), ModifiedByUserID = "_admin", ModifiedDate = new DateTime(2016,1,1) },
                new AssetType() { ID = 2, CreatedByUserID = "_admin", CreatedDate = new DateTime(2016, 1, 1), ModifiedByUserID = "_admin", ModifiedDate = new DateTime(2016,1,1) },
                new AssetType() { ID = 3, CreatedByUserID = "_admin", CreatedDate = new DateTime(2016, 1, 1), ModifiedByUserID = "_admin", ModifiedDate = new DateTime(2016,1,1) }
            };
            return assetTypes;
        }
        ...
        public static List<Campus> GetAllCampuses()
        {
            ...
            {
                new Campus() { ID = 2, Name = "Gold Camp", Address = "3101 Gold Camp Drive", Address2 = "Testing Address1", City = "Rancho Cordova", ZipCode = "95670", IsActive = true, CreatedByUserID = "-1", CreatedDate = new DateTime(2016, 1, 1), ModifiedByUserID = "-1", ModifiedDate = new DateTime(2016, 1, 1) },
                new Campus() { ID = 4, Name = "J Street Building", Address = "1325 J Street", Address2 = "Suite 1600", City = "Sacramento", ZipCode = "95814", IsActive = true, CreatedByUserID = "-1", CreatedDate =  new DateTime(2016, 1, 1), ModifiedByUserID = "", ModifiedDate = new DateTime(2016, 1, 1) },
                new Campus() { ID = 5, Name = "Prospect Green 1", Address = "10860 Gold Center Drive", Address2 = null, City = "Rancho Cordova", ZipCode = "95670", IsActive = true, CreatedByUserID = "-1", CreatedDate =  new DateTime(2016, 1, 1), ModifiedByUserID = "", ModifiedDate = new DateTime(2016, 1, 1) },
                new Campus() { ID = 6, Name = "Prospect Green 3", Address = "10911 White Rock Road", Address2 = null, City = "Rancho Cordova", ZipCode = "95670", IsActive = true, CreatedByUserID = "-1", CreatedDate = new DateTime(2016, 1, 1), ModifiedByUserID = "", ModifiedDate = new DateTime(2016, 1, 1) },
                new Campus() { ID = 7, Name = "Croydon Warehouse", Address = "10173 Croydon Way", Address2 = null, City = "Sacramento", ZipCode = "95827", IsActive = true, CreatedByUserID = "-1", CreatedDate = new DateTime(2016, 1, 1), ModifiedByUserID = "", ModifiedDate = new DateTime(2016, 1, 1) },
                new Campus() { ID = 8, Name = "Vacaville DataCenter", Address = "123 Main Streets", Address2 = null, City = "Vacaville", ZipCode = "55555", IsActive = true, CreatedByUserID = "-1", CreatedDate = new DateTime(2016, 1, 1), ModifiedByUserID = "", ModifiedDate = new DateTime(2016, 1, 1) }
            };
            return campuses;
        }
        #endregion
