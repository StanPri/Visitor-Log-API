...
IF ((SELECT COUNT(1) FROM [dbo].[Campus] WHERE ID = 1 ) = 0 ) 
	INSERT INTO [dbo].[Campus] ([ID], [Name], [Address], [City], [ZipCode], [IsActive]) 
	VALUES (1, 'Gold Camp', '3101 Gold Camp Drive', 'Rancho Cordova', '95670', 1)
IF ((SELECT COUNT(1) FROM [dbo].[Campus] WHERE ID = 2 ) = 0 ) 
	INSERT INTO [dbo].[Campus] ([ID], [Name], [Address], [Address2], [City], [ZipCode], [IsActive]) 
	VALUES (2, 'J Street Building', '1325 J Street', 'Suite 1600', 'Sacramento', '95670', 1)
IF ((SELECT COUNT(1) FROM [dbo].[Campus] WHERE ID = 3 ) = 0 ) 
	INSERT INTO [dbo].[Campus] ([ID], [Name], [Address], [City], [ZipCode], [IsActive]) 
	VALUES (3, 'Prospect Green 1', '10860 Gold Center Drive', 'Rancho Cordova', '95670', 1)
IF ((SELECT COUNT(1) FROM [dbo].[Campus] WHERE ID = 4 ) = 0 ) 
	INSERT INTO [dbo].[Campus] ([ID], [Name], [Address], [City], [ZipCode], [IsActive]) 
	VALUES (4, 'Prospect Green 3', '10911 White Rock Road', 'Rancho Cordova', '95670', 1)
IF ((SELECT COUNT(1) FROM [dbo].[Campus] WHERE ID = 5 ) = 0 ) 
	INSERT INTO [dbo].[Campus] ([ID], [Name], [Address], [City], [ZipCode], [IsActive]) 
	VALUES (5, 'Croydon Warehouse', '10173 Croydon Way', 'Sacramento', '95827', 1)
IF ((SELECT COUNT(1) FROM [dbo].[Campus] WHERE ID = 6 ) = 0 ) 
	INSERT INTO [dbo].[Campus] ([ID], [Name], [Address], [City], [ZipCode], [IsActive]) 
	VALUES (6, 'Vacaville Data Center', '123 Main Streets', 'Vacaville', '55555', 1)
