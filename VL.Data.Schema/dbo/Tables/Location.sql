CREATE TABLE [dbo].[Location] (
    ...
    [CreatedByUserID]  VARCHAR (50) CONSTRAINT [DF_Location_CreatedByUserID] DEFAULT ((-1)) NOT NULL,
    [CreatedDate]      DATETIME     CONSTRAINT [DF_Location_CreatedDate] DEFAULT (getdate()) NOT NULL,
    [ModifiedByUserID] VARCHAR (50) CONSTRAINT [DF_Location_ModifiedByUserID] DEFAULT ((-1)) NOT NULL,
