CREATE TABLE [dbo].[LogVisitor] (
    ...
    CONSTRAINT [PK_LogVisit_1] PRIMARY KEY CLUSTERED ([LogID] ASC, [VisitorID] ASC, [ContactID] ASC, [LocationID] ASC, [CompanyID] ASC),
    CONSTRAINT [FK_LogVisit_Contact] FOREIGN KEY ([ContactID]) REFERENCES [dbo].[Contact] ([ID]),
    CONSTRAINT [FK_LogVisitor_Company] FOREIGN KEY ([CompanyID]) REFERENCES [dbo].[Company] ([ID]),
