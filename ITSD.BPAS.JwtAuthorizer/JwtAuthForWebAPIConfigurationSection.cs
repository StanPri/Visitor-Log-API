...
namespace ITSD.BPAS.JwtAuthorizer
{
    ...
    {
        public static readonly JwtAuthForWebApiConfigurationSection Current = (JwtAuthForWebApiConfigurationSection) ConfigurationManager.GetSection("JwtAuthorization");
